  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="display:flex;justify-content:center">
        <img src="{{ $user->profile_image}}" style="max-width:100%" class="ratio img-responsive img-circle" alt="Profile image">
...
@section('left')
  <div class="box-shadow-profile">
    ...
    <div style="display:flex;justify-content:center">
      <div>
          <a data-toggle="modal" data-target="#image"><img src="{{ $user->profile_image}}" style="max-width:150px" class="ratio img-responsive img-circle" alt="Profile image"></a>
      </div>
      <div>
      </div>
    </div>
